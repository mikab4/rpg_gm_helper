...
def test_build_relationship_type_response_for_custom_type_preserves_custom_metadata() -> None:
...
def test_build_relationship_type_response_for_built_in_type_marks_response_as_not_custom() -> None:
